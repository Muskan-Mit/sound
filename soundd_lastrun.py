...
expName = 'soundd'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\HP\\Desktop\\Muskan\\3 Year Subject\\Lab in Psychology\\soundd_lastrun.py',
...
polygon_2 = visual.ShapeStim(
    ...
    size=(0.2, 0.2), vertices='circle',
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor='white', fillColor=[0.7412, 0.4431, 0.0588],
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/HP/Desktop/Muskan/3 Year Subject/Lab in Psychology/sound.csv'),
...
for thisTrial in trials:
    ...
    continueRoutine = True
    # update component parameters for each repeat
    sound_1.setSound(freq, secs=0.5, hamming=True)
